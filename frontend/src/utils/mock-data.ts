...
export const mockNttMonitoring = [
  {
    id: "kota-kupang",
    name: "Kota Kupang",
    shortLabel: "Kupang",
    ...
    bufferTon: 58,
    alerts: 2,
    notes: "Distribusi RPK Oebobo menunggu armada pengiriman.",
    updatedAt: "2025-09-21T10:20:00+08:00",
  },
  {
    id: "kab-kupang",
    name: "Kabupaten Kupang",
    shortLabel: "Kab. Kupang",
    latitude: -10.2667,
    longitude: 123.6005,
    status: "normal",
    progress: 81,
    ...
    bufferTon: 72,
    alerts: 0,
    notes: "Cadangan cukup, fokus validasi ERDKK desa prioritas.",
    updatedAt: "2025-09-20T17:45:00+08:00",
  },
  {
    id: "tts",
    ...
    bufferTon: 64,
    alerts: 1,
    notes: "Koordinasi PPL untuk jadwal tanam terpadu minggu depan.",
    updatedAt: "2025-09-19T09:30:00+08:00",
  },
  {
    id: "ttu",
    ...
    bufferTon: 45,
    alerts: 2,
    notes: "Distribusi pupuk Urea Biboki masih tertahan di gudang Kefamenanu.",
    updatedAt: "2025-09-21T14:05:00+08:00",
  },
  {
    id: "belu",
    name: "Belu",
    ...
    bufferTon: 70,
    alerts: 0,
    notes: "Stok Bulog Atambua stabil, tidak ada antrian distribusi.",
    updatedAt: "2025-09-22T07:50:00+08:00",
  },
  {
    id: "malaka",
    name: "Malaka",
    ...
    bufferTon: 55,
    alerts: 0,
    notes: "Penjadwalan ulang kawal distribusi berhasil menekan keterlambatan.",
    updatedAt: "2025-09-20T16:10:00+08:00",
  },
  {
    id: "rote-ndao",
    name: "Rote Ndao",
    ...
    bufferTon: 20,
    alerts: 3,
    notes: "Cuaca buruk menghambat pelayaran Ba'a - Kupang, stok perlu suplai darurat.",
    updatedAt: "2025-09-22T06:40:00+08:00",
  },
  {
    id: "sabu-raijua",
    name: "Sabu Raijua",
    ...
    bufferTon: 18,
    alerts: 2,
    notes: "Sebagian laporan lapangan belum tersinkron, pantau konektivitas PPL.",
    updatedAt: "2025-09-21T11:15:00+08:00",
  },
  {
    id: "alor",
    name: "Alor",
    ...
    bufferTon: 24,
    alerts: 2,
    notes: "Pengiriman stok antar pulau masih bergantung jadwal kapal Sabtu.",
    updatedAt: "2025-09-20T08:20:00+08:00",
  },
  {
    id: "flores-timur",
    name: "Flores Timur",
    shortLabel: "Flores Timur",
    latitude: -8.3214,
    longitude: 122.9702,
    status: "warning",
    progress: 68,
    ...
    bufferTon: 40,
    alerts: 1,
    notes: "Perlu percepatan sinkronisasi data kios Larantuka.",
    updatedAt: "2025-09-21T13:05:00+08:00",
  },
  {
    id: "sikka",
    name: "Sikka",
    ...
    bufferTon: 12,
    alerts: 4,
    notes: "Gudang Maumere butuh pasokan tambahan, jadwalkan kawal distribusi.",
    updatedAt: "2025-09-22T09:25:00+08:00",
  },
  {
    id: "ende",
    name: "Ende",
    ...
    bufferTon: 52,
    alerts: 1,
    notes: "Monitoring logistik kombinasi jalur laut dan darat berjalan baik.",
    updatedAt: "2025-09-21T10:50:00+08:00",
  },
  {
    id: "manggarai-barat",
    name: "Manggarai Barat",
    shortLabel: "Manggarai",
    latitude: -8.4527,
    longitude: 120.4524,
    status: "normal",
    progress: 88,
    ...
    bufferTon: 68,
    alerts: 0,
    notes: "Sistem buffer stok Labuan Bajo on-track, fokus antisipasi musim hujan.",
    updatedAt: "2025-09-19T15:00:00+08:00",
  },
  {
    id: "sumba-timur",
    name: "Sumba Timur",
    shortLabel: "Sumba Timur",
    latitude: -9.8658,
    longitude: 120.2636,
    status: "warning",
    progress: 66,
    ...
    bufferTon: 34,
    alerts: 2,
    notes: "Kebutuhan solar subsidi untuk angkut hasil panen meningkat.",
    updatedAt: "2025-09-20T12:30:00+08:00",
  },
  {
    id: "sumba-barat",
    name: "Sumba Barat",
    shortLabel: "Sumba Barat",
    latitude: -9.637,
    longitude: 119.3947,
    status: "normal",
    progress: 72,
    ...
    bufferTon: 46,
    alerts: 1,
    notes: "Distribusi kios desa prioritas berjalan sesuai jadwal.",
    updatedAt: "2025-09-19T18:20:00+08:00",
  },
] as const;
