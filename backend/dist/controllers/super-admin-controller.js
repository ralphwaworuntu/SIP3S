...
const plantUpdateSchema = plantPayloadSchema.fork(["wilayah", "petani", "komoditas", "fase", "kondisi", "catatan", "lokasi", "fotoEvidence"], (schema) => schema.optional());
...
const harvestUpdateSchema = harvestPayloadSchema.fork(["petani", "komoditas", "luasPanenHa", "produksiTon", "lokasi", "koordinat", "fotoEvidence"], (schema) => schema.optional());
...
export const getSuperAdminOverviewController = async (_req, res) => {
    const overview = await service.getOverview();
    res.json(overview);
};
export const listSuperAdminTasksController = async (_req, res) => {
    const tasks = await service.listTasks();
    res.json(tasks);
};
export const createSuperAdminTaskController = async (req, res) => {
    const { error, value } = taskPayloadSchema.validate(req.body, { stripUnknown: true });
    if (error) {
        res.status(400).json({ message: error.message });
        return;
    }
    const record = await service.createTask(value);
    res.status(201).json(record);
};
export const updateSuperAdminTaskController = async (req, res) => {
    const { error, value } = taskUpdateSchema.validate(req.body, { stripUnknown: true });
    if (error) {
        res.status(400).json({ message: error.message });
        return;
    }
    const updated = await service.updateTask(req.params.id, value);
    if (!updated) {
...
export const updateSuperAdminTaskStatusController = async (req, res) => {
    const { error, value } = taskStatusSchema.validate(req.body, { stripUnknown: true });
    if (error) {
        res.status(400).json({ message: error.message });
        return;
    }
    const updated = await service.updateTaskStatus(req.params.id, value.status);
    if (!updated) {
        res.status(404).json({ message: "Tugas tidak ditemukan" });
        return;
    }
...
export const deleteSuperAdminTaskController = async (req, res) => {
    await service.removeTask(req.params.id);
    res.status(204).send();
};
export const listSuperAdminRecipientsController = async (_req, res) => {
    const recipients = await service.listRecipients();
    res.json(recipients);
};
export const updateSuperAdminRecipientController = async (req, res) => {
    ...
    try {
        const updated = await service.updateRecipient(req.params.id, value);
        res.json(updated);
    }
    catch (err) {
...
export const listSuperAdminPlantReportsController = async (_req, res) => {
    const reports = await service.listPlantReports();
    res.json(reports);
};
export const createSuperAdminPlantReportController = async (req, res) => {
...
export const updateSuperAdminPlantReportController = async (req, res) => {
...
export const deleteSuperAdminPlantReportController = async (req, res) => {
    try {
...
export const listSuperAdminHarvestController = async (_req, res) => {
    const harvests = await service.listHarvestVerifications();
    res.json(harvests);
};
export const createSuperAdminHarvestController = async (req, res) => {
...
export const updateSuperAdminHarvestController = async (req, res) => {
...
export const deleteSuperAdminHarvestController = async (req, res) => {
    try {
...
export const listSuperAdminEscortController = async (_req, res) => {
    const escorts = await service.listEscortRequests();
    res.json(escorts);
};
export const createSuperAdminEscortController = async (req, res) => {
...
export const updateSuperAdminEscortController = async (req, res) => {
...
export const deleteSuperAdminEscortController = async (req, res) => {
    try {
...
export const listSuperAdminAccountsController = async (_req, res) => {
    const accounts = await service.listBhabinAccounts();
    res.json(accounts);
};
export const createSuperAdminAccountController = async (req, res) => {
...
export const updateSuperAdminAccountController = async (req, res) => {
...
export const deleteSuperAdminAccountController = async (req, res) => {
    try {
